        ...
        <div class="grid" :style="{ 'margin-left': '-2rem' }">
            ...
            <div class="col-12 md:col-8">
                ...
                <div class="card h-30rem">
                    <DataTable ref="dt" :value="lineItems" dataKey="sku" :paginator="true" :rows="10" :filters="filters" :loading="tableLoading"
                      ...
                      <Column field="kg_per_unit" header="KG/Unit" :sortable="true" headerStyle="width:14%; min-width:8rem;">
                        <template #body="slotProps">
                          <span class="p-column-title">KG/Unit</span>
            ...
            <div class="card h-30rem">
                <DataTable ref="dt" :value="addedLineItems" v-model:selection="selectedProducts" dataKey="id"
                    ...
                    <template #header>
                        <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center"
                            :style="{ 'margin-top': '5px' }">
                            <h5 style="color: #808080">Delivered</h5>
                        </div>
                        <div class="flex justify-content-between gap-6 mt-2">
                            <div class="flex gap-2">
                                <div>
                    ...
                    <template >
                        ...
                        <Column field="ordered" header="Ordered" :sortable="true" headerStyle="width:14%; min-width:8rem;">
                            <template #body="slotProps">
                                <span class="p-column-title">Std Wgt(G)</span>
                                {{ slotProps.data.weight_per_unit }}
                            </template>
                        </Column>
                        <Column field="dispatched" header="Dispatched" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                            <template #body="slotProps">
                                <span class="p-column-title">Dispatched</span>
                                {{ slotProps.data.inv_eq || '-' }}
                            </template>
                        </Column>
                        <Column field="delivered" header="Delivered" :sortable="true"
                            headerStyle="width:14%; min-width:10rem;">
                            <template #body="slotProps">
                        ...
                        <Column field="rejected" header="Rejected" :sortable="true"
                            headerStyle="width:14%; min-width:10rem;">
                            <template #body="slotProps">
                        ...
                        <Column field="reason" header="Reason" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                            <template #body="slotProps">
            ...
            <div class="card h-30rem">
                <DataTable ref="dt" :value="addedLineItems" v-model:selection="selectedProducts" dataKey="id"
                    ...
                    <template #header>
                        <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center"
                            :style="{ 'margin-top': '5px' }">
                            <h5 style="color: #808080">ETIMS Info</h5>
                        </div>
                        <div class="flex justify-content-between gap-6 mt-2">
                            <div class="flex gap-2">
                                <div>
                    ...
                    <template >
                        <Column field="scu" header="SCU" :sortable="true"
                            headerStyle="width:3%; min-width:3rem;">
                            <template #body="slotProps">
                                <span class="p-column-title">SCU</span>
                                {{ slotProps.data.code }}
                            </template>
                        </Column>
                        <Column field="url" header="URL" headerStyle="width:14%; min-width:10rem;">
                            <template #body="slotProps">
            ...
            <div class="col-12 md:col-4">
                <div class="card p-fluid" :style="{}">
                    ...
                    <div class="flex flex-1 justify-content-end mt-3">
                        <Button type="button" label="Download Invoice" icon="pi pi-download" class="font-bold"
                                    :style="{ 'background-color': '#DFEDDF', border: '#DFEDDF' ,'color':'#122C20','width':'55%'}"
                                    @click="exportCSV($event)"></Button>
                    </div>
                </div>
                ...
                <div class="card p-fluid" :style="{}">
                    ...
                    <div :style="{ display: 'flex', 'flex-direction': 'column', gap: '16px' }">
                        <div class="flex justify-content-between">
                            <div :style="{ 'font-color': '#F6F6F6' }">{{orderData ? orderData.delivery_notes : '-'}}</div>
