...
const handleMenuAction = (action, item) => {
    ...
    store.dispatch('orders/setOrderDetailsArray', selectedItem);

    router.push('/sales/edit-order');
                    ...
                    <template #header>
                        ...
                        <div class="flex justify-content-between gap-6 mt-2" :style="{ 'margin-left': '-15px' }">
                            <div class="flex gap-2">
                                ...
                                <div>
                                    <Calendar v-model="calendarRange" selectionMode="range" :manualInput="false" placeholder="Select Date Range" @change="filterByDate" showIcon></Calendar>
                                </div>
                                <div>
