        ...
        <div class="col-12">
            <div class="card">
                <DataTable ref="dt" :value="products" v-model:selection="selectedProducts" dataKey="id"
                        ...
                        <div class="flex justify-content-between gap-6 mt-2" :style="{ 'margin-left': '-15px' }">
                            <div class="flex gap-2">
                                ...
                                <div>
                                    ...
                                    <Dropdown id="state" v-model="status" :options="returnsActions" optionLabel="value"
                                        placeholder="Select Action"></Dropdown>
                                </div>
                            </div>
                    ...
                    <Column field="orderNo" header="Order No." headerStyle="width:14%; min-width:10rem;"
                        @click="openSidebar()">
                ...
                <Dialog v-model:visible="filterDialog" :style="{ width: '350px' }" :modal="true" class="p-fluid">
                    ...
                    <div class="field">
                        <Calendar v-model="calenderValue" :manualInput="false" placeholder="Select Issued Date">
                        </Calendar>
                    </div>
                    <div class="field">
                    ...
                    <div class="field">
                        <Dropdown id="inventoryStatus" v-model="product.inventoryStatus" :options="statuses"
                            optionLabel="value" placeholder="Select Payment Type">
                            <template #value="slotProps">
                                <div v-if="slotProps.value && slotProps.value.value">
                                    <span :class="'product-badge status-' + slotProps.value.value">{{
                                        slotProps.value.label }}</span>
...
.p-sidebar .p-sidebar-close.p-sidebar-icon.p-link .p-icon {
