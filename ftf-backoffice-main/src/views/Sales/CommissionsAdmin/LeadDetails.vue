...
<template>
    ...
    <div class="flex justify-content-between">
        <h5 :style="{ 'font-size': 'large', 'font-weight': 'bold', 'margin-left': '-2rem', 'color': '#122C20' }">
            <router-link :to="{ path: '/sales/commissions-admin' }" class="back-arrow">
                <i class="pi pi-arrow-left" :style="{ 'color': '#122C20' }"></i>
            </router-link> {{ leadOwner }} - {{month}} - Commissions
        </h5>
        </div>
    ...
    <div class="grid" :style="{ 'margin-left': '-2rem' }">
        <div class="w-full">
            ...
            <div class="card mt-4">
                <h5 :style="{ color: 'gray', 'font-size': 'medium', 'margin-left': '-10px' }">Monthly Commissions</h5>
...
<style scoped>
/* Override the p-tabmenu and p-component classes */
.custom-tabmenu .p-tabmenu.p-component {
  ...
  .custom-tabmenu .p-tabmenu.p-component {
    ...
    border-bottom: 2px solid grey; /* Grey line at the bottom */
  }
  
  .custom-tabmenu .p-tabmenu.p-component .p-tabmenu-nav {
    background-color: transparent; /* Transparent background */
  }
  
  .custom-tabmenu .p-tabmenu.p-component .p-tabmenu-nav .p-tabmenuitem {
    padding: 10px; /* Custom padding */
    color: #333; /* Custom text color */
  }
  
  .custom-tabmenu .p-tabmenu.p-component .p-tabmenu-nav .p-highlight {
    border-bottom: 2px solid grey !important; /* Active tab bottom border */
  }
</style>
