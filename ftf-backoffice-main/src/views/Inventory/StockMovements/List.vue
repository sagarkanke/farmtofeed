        ...
        <div class="col-12">
            <div class="card">
                <DataTable ref="dt" :value="deductions" dataKey="id" :paginator="true" :rows="10" :filters="filters"
                    ...
                    <template #header>
                        <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center"
                            ...
                            <h5 class="m-0 text-color-secondary">Stock Movements</h5>
                        </div>
                        <div class="flex justify-content-between gap-6 mt-2" :style="{ 'margin-left': '-15px' }">
                            ...
                            <div class="flex gap-2" :style="{ 'margin-right': '-22px' }">
                                ...
                                <Button type="button" label="Add Stock Movement" icon="pi pi-plus"
                ...
                <Dialog v-model:visible="addDeductionFlag" :style="{ width: '450px' }" :modal="true" class="p-fluid">
                    ...
                    <div class="field">
                        <label for="name" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Date of
                            Movement</label>
                        <Calendar v-model="dateOfMovement"  showIcon :manualInput="false"
                            placeholder="Select Date Range"></Calendar>

                    </div>
                    <div class="field mt-3">
                        <label for="name" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Product</label>
                        <Dropdown v-model="selectedProduct" :options="productDropdown" optionLabel="name"
                            class="border-round-lg	" optionValue="id" placeholder="Select Product">
                        </Dropdown>
                    </div>
                    <div class="field">
                        <label for="name" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Grade to move to
                        </label>
                        <Dropdown v-model="selectedGrade" :options="grades" optionLabel="name" placeholder="Select">
                        </Dropdown>
                    </div>
                ...
                <Dialog v-model:visible="editDeductions" :style="{ width: '450px' }" :modal="true" class="p-fluid">
                    ...
                    <div class="field">
                        <label for="name" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Date of
                            Movement</label>
                        <Calendar v-model="calendarRange" selectionMode="range" showIcon :manualInput="false"
                            placeholder="Select Date Range"></Calendar>
