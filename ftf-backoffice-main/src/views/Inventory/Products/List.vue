...
const fetchAllProductsList = async () => {
    ...
    //    media: variation.media? variation.media: []
    }]
);
...
const handleMenuAction = (action, item) => {
    ...
    if (action === 'Edit') {
        ...
        selectedItem.value.media.map((img)=>{
            images.value.push({
    ...
    <div class="grid" :style="{ 'margin-left': '-50px', 'margin-top': '-30px' }">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable ref="dt" :value="filteredProducts" v-model:selection="selectedOrders" dataKey="id" :loading="isLoading"
                    ...
                    <Column field="semiProcessed" header="Semi Processed" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                    ...
                    <Column field="size" header="Size" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            ...
                            {{ slotProps.data.size }} </template>
                    </Column>
                    <Column field="grade" header="Ripeness" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">Ripeness</span>
                            {{ slotProps.data.ripeness }} </template>
                    </Column>
                    <Column field="avgShelfLife" header="Avg. Shelf Life" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">Avg.Shelf Life</span>
                            {{ slotProps.data.avgShelfLife }} </template>
                    </Column>
                    <Column field="avgPrice" header="Avg. Price" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">Avg. Price</span>
                            {{ slotProps.data.avgPrice }} </template>
                    </Column>
