	...
	<div class="grid">
		<div class="col-12 lg:col-6 xl:col-3">
			<div class="card mb-0">
				...
				<span class="text-green-500 font-medium">vs Last month </span>
				<span class="text-500">$889,1M</span>
			</div>
		</div>
		<div class="col-12 lg:col-6 xl:col-3">
			<div class="card mb-0">
		...
		<div class="col-12 xl:col-6">
			<div class="card">
				<h5>map</h5>
				<GMapMap :center="{ lat: 51.093048, lng: 6.84212 }" :zoom="7" map-type-id="terrain" style="width: 100%; height: 300px"> </GMapMap>
			</div>
			<div class="card">
