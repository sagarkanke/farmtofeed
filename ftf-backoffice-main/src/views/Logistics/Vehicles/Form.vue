...
<template>
  ...
  <div :style="{ marginLeft: '-26px' }">
    ...
    <Form :loading="false" :initial-values="props.initialValues" :validation-schema="props.validationSchema"
      @submit="onSubmit" v-slot="{ values, errors, handleSubmit, setFieldValue }">
            ...
            <div class="card p-fluid">
              ...
              <div class="formgrid grid">
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="registration_number" name="registration_number"   :invalid="!!errors.registration_number" as="InputText"
                    :class="['p-inputtext', 'w-full' , { 'p-invalid': errors.registration_number }]" />
                ...
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="ownership" name="ownership">
                    <template #default="{ field, meta }">
                      <Dropdown v-model="field.value"  :invalid="!!errors.ownership"  @change="handleDropdownChange(field.value, setFieldValue)"
              ...
              <div class="formgrid grid">
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="owner" name="owner">
                    <template #default="{ field, meta }">
                      <Dropdown v-model="field.value" :invalid="!!errors.owner"  @change="handleVehicleOwnerChange(field.value, setFieldValue)"
                ...
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="phone_number"  :invalid="!!errors.phone_number" name="phone_number" as="InputText" :class="['p-inputtext', 'w-full']" />
              ...
              <div class="formgrid grid">
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="vehicle" name="vehicle">
                    <template #default="{ field, meta }">
                      <Dropdown v-model="field.value" :invalid="!!errors.vehicle" @change="handleVehicleChange(field.value, setFieldValue)"
                ...
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="load_capacity" name="load_capacity" as="InputText" :invalid="!!errors.load_capacity" :class="['p-inputtext', 'w-full']" />
                  <ErrorMessage name="load_capacity" class="p-error" />
                </div>
                <div class="field col-12 md:col-12">
                  <label for="tank_capacity">Tank Capacity </label>
                  <Field id="tank_capacity" name="tank_capacity" as="InputText"  :invalid="!!errors.tank_capacity"  :class="['p-inputtext', 'w-full']" />
            ...
            <div class="card p-fluid">
              ...
              <div class="formgrid grid">
                ...
                <div class="field col-12 md:col-12">
                  ...
                  <Field id="ksh_km" name="ksh_km" as="InputText" :invalid="!!errors.ksh_km"   :class="['p-inputtext', 'w-full']" />
              ...
              <div class="formgrid grid">
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="lease_rate" name="lease_rate">
                    <template #default="{ field, meta }">
                      <Dropdown v-model="field.value"   :invalid="!!errors.lease_rate"    @change="handleDropdownLeaseChange(field.value, setFieldValue)"
                ...
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="lease_cost" name="lease_cost" as="InputText"  :invalid="!!errors.lease_cost"   :class="['p-inputtext', 'w-full']" />
                ...
                <div class="field col-12 md:col-6">
                  ...
                  <Field id="lease_expiration_date" name="lease_expiration_date">
                    <template #default="{ field, meta }">
                      <Calendar   :invalid="!!errors.lease_expiration_date" v-bind="field" v-model="field.value" :class="['w-full', { 'p-invalid': meta.error }]"
            ...
            <div class="card" :style="{ 'margin-top': '-14px' }">
              ...
              <div :style="{ display: 'flex', 'flex-direction': 'column', gap: '16px' }">
                ...
                <div class="flex justify-content-between">
                  ...
                  <div>{{ values ? values.lease_rate?.label : '' }}</div>
                </div>
                <div class="flex justify-content-between">
