...
const selectedItem = computed(() => store.getters['suppliers/getSelectedItem']);
    ...
    <div class="grid mt-2" :style="{ 'margin-left': '-3rem' }">
        <div class="col-12 md:col-8">
            ...
            <div class="card" v-if="activeTab === 'orders'">
                <DataTable ref="dt" :value="farmerOrders" v-model:selection="selectedOrders" dataKey="id"
                    ...
                    <Column field="amount" header="Amount" headerStyle="width:14%; min-width:13rem;">
                        <template #body="slotProps">
                            {{ slotProps.data?.totalOrderAmount || '-' }}

                        </template>
                    </Column>
                    <Column field="sourcingType" header="Sourcing Type" headerStyle="width:14%; min-width:13rem;">
                        <template #body="slotProps">
                            {{ slotProps.data?.sourcingType || '-' }}

                        </template>
                    </Column>
                    <Column field="sourcingTime" header="Sourcing Time" headerStyle="width:14%; min-width:13rem;">
                        <template #body="slotProps">
                            {{ slotProps.data?.sourcingTime || '-' }}
            ...
            <div class="card" v-if="activeTab === 'payments'">
                <DataTable ref="dt" :value="payments" v-model:selection="selectedOrders" dataKey="id"
                    :paginator="true" :rows="10" :filters="filters"
                    paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                    :rowsPerPageOptions="[5, 10, 25]"
                    currentPageReportTemplate="Showing {first} to {last} of {totalRecords} orders">
                    ...
                    <Column field="rejectedItems" header="Rejected Items" headerStyle="width:14%; min-width:13rem;">
                        <template #body="slotProps">
                    ...
                    <Column field="dateReceived" header="Date Received" headerStyle="width:14%; min-width:13rem;">
                        <template #body="slotProps">
                            {{ slotProps.data?.fulfillment_date || '-' }}
            ...
            <!-- Farmers -->
            <div class="card" v-if="activeTab === 'farmers'">
                <DataTable ref="dt" :value="farmerList" v-model:selection="selectedOrders" dataKey="id"
                    ...
                    <Column field="phoneNo" header="Phone No." headerStyle="width:14%; min-width:13rem;">
                        <template #body="slotProps">
            ...
            <!-- Interaction -->
            <div  v-if="activeTab === 'interaction'" class="w-full">
               
                    <div class="flex flex-column">
                      <div v-if="interactionLogs?.length > 0">
                        <div v-for="interaction in interactionLogs" :key="interaction.id" class="col-12 md:col-12">
                            <div class="card">
                                <h5>{{interaction.name}}</h5>
                                <h6 class="-mt-2 text-color-secondary">{{ interaction.date }}</h6>
                      ...
                      <!-- Display this card when no data is available -->
                      <div v-else>
                        <div class="justify-content-center mt-4" :style="{'margin-left': '16rem'}">
            ...
            <div class="card p-fluid" :style="{}">
                ...
                <div :style="{ display: 'flex', 'flex-direction': 'column', gap: '16px' }">
                    <div class="flex justify-content-between">
                        ...
                        <div>{{ selectedItem ? selectedItem?.user?.name : '-' }}</div>
                    </div>
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">Supplier Type</div>
                        <div>{{ selectedItem ? selectedItem?.supplie_type : '-' }}</div>
                    </div>
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">Last Contacted</div>
                        <div>{{ selectedItem ? selectedItem?.last_contacted : '-' }}</div>
                    </div>
                ...
                <div :style="{ display: 'flex', 'flex-direction': 'column', gap: '16px' }">
                    ...
                    <div class="flex justify-content-between">
                        ...
                        <div>{{ selectedItem ? selectedItem?.user?.email : '-' }}</div>
                    </div>
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">Phone</div>
                        <div>{{ selectedItem ? selectedItem?.user?.phone: '-' }}</div>
                    </div>
                ...
                <div :style="{ display: 'flex', 'flex-direction': 'column', gap: '16px' }">
                    <div class="flex justify-content-between">
                        ...
                        <div>{{ selectedItem ? selectedItem?.address?.street : '-' }}</div>
                    </div>
                    <div class="flex justify-content-between">
                ...
                <div :style="{ display: 'flex', 'flex-direction': 'column', gap: '16px' }">
                    <div class="flex justify-content-between">
                        ...
                        <div>{{ selectedItem ? selectedItem?.mpesa_number: '-' }}</div>
                    </div>
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">Payment Preference</div>
                        <div>{{selectedItem ? selectedItem?.payment_method : '-'}}</div>
                    </div>
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">KRA Pin</div>
                        <div>{{ selectedItem ? selectedItem?.kra_pin : '-' }}</div>
                    </div>
