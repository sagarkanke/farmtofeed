...
let selectedSupplierType = ref(null);
...
selectedSupplierType.value = selectedItem.value.supplier_type;
firstName.value = selectedItem.value.user?.name;
lastName.value = " ";
email.value = selectedItem.value.user?.email;
phone.value = selectedItem.value.user?.phone;
location.value = selectedItem.value.address?.street;
...
<template>
    <div class="flex justify-content-between">
        <h5 :style="{ 'font-size': 'large', 'font-weight': 'bold', 'margin-left': '-2rem' }">Edit Supplier:{{selectedItem?.user?.name}}</h5>
                    ...
                    <div class="flex gap-2 ml-3">
                        <div class="field flex-1 flex flex-column">
                            ...
                            <InputText id="username2" :style="{ borderRadius: '8px' }" type="username" class="p-error"
                                v-model="selectedItem.user.name" aria-describedby="username-help" />
                        ...
                        <div class="field flex-1 flex flex-column">
                            ...
                            <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedItem.supplier_type" :options="supplierTypes" optionLabel="label"
                                placeholder="Select" />
                        </div>
                    </div>
                </div>
