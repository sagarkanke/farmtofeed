...
// Function to get subcounties by county id
function getSubcountiesByCountyId(countyId) {
  subCounties.value = countiesJsonData.value.find(county => county.id === countyId);
  if (selectedCounty) {
    return selectedCounty.constituencies.map(subcounty => ({
      id: subcounty.id,
      title: subcounty.title,
    }));
  }
  return [];
}

// Function to get wards by subcounty id
function getWardsBySubcountyId(countyId, subcountyId) {
  wards.value = countiesJsonData.find(county => county.id === countyId);
  if (wards) {
    const selectedSubcounty = wards.values.constituencies.find(
      subcounty => subcounty.id === subcountyId
    );
    if (selectedSubcounty) {
      return selectedSubcounty.wards.map(ward => ({
        id: ward.id,
        title: ward.title,
      }));
    }
...
onMounted(() => {
  ...
  countiesJsonData.value = data; // Assign the resolved data to countiesJsonData
  counties.value = countiesJsonData.value.map(county => ({ id: county.id, title: county.title })); // Map to get the id and title
...
<template>
    <div class="flex justify-content-between">
        <h5 :style="{ 'font-size': 'large', 'font-weight': 'bold', 'margin-left': '-2rem' }">New Farmer</h5>
    ...
    <div class="grid" :style="{ 'margin-left': '-3rem' }">
        <div class="col-12 md:col-8">
                    ...
                    <div class="flex gap-2 ml-3">
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod"
                                :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Date of Birth</label>
                            <Calendar id="username2" :style="{ borderRadius: '8px' }" type="username" class="p-error"
                                v-model="email" aria-describedby="username-help" />
                            <!-- <Dropdown id="deliveryLocation" v-model="selectedDeliveryLocation" :options="deliveryLocations" placeholder="Select Delivery Location" /> -->
                        </div>
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod"
                                :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Gender</label>
                                <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedGender" :options="genders" optionLabel="label"
                                placeholder="Select" />
                        </div>
                    </div>
                    <div class="flex gap-2 ml-3">
                        ...
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod"
                                :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Phone Number</label>
                                <InputText id="username2" :style="{ borderRadius: '8px' }" type="username" class="p-error"
            ...
            <div class="card">
                <h5 :style="{ color: 'gray', 'font-size': 'medium', 'margin-left': '-10px' }">Farm Details</h5>
                <div :style="{ 'margin-left': '-22px' }">
                    <!-- First Row -->
                    <div class="flex gap-2 ml-3">
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">No. of Acres
                                </label>
                            <InputNumber id="username2" :style="{ borderRadius: '8px' }" type="username" class="p-error"
                                v-model="noOfAcres" aria-describedby="username-help" />
                            <!-- <Dropdown id="deliveryLocation" v-model="selectedDeliveryLocation" :options="deliveryLocations" placeholder="Select Delivery Location" /> -->
                        </div>
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Ownership
                                </label>
                                <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedGender" :options="genders" optionLabel="label"
                                placeholder="Select" />
                    ...
                    <div class="flex gap-2 ml-3">
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Farming Type
                                </label>
                                <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedGender" :options="genders" optionLabel="label"
                                placeholder="Select" />
                        ...
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Irrigation
                                </label>
                                <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedGender" :options="genders" optionLabel="label"
                                placeholder="Select" />
                    ...
                    <div class="flex gap-2 ml-3">
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Where they ususally sell their produce?
                                </label>
                                <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedGender" :options="genders" optionLabel="label"
                                placeholder="Select" />
                        ...
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Food Loss destination
                                </label>
                                <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedGender" :options="genders" optionLabel="label"
                                placeholder="Select" />
                    ...
                    <div class="flex gap-2 ml-3">
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Supplying Via
                                </label>
                                <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedGender" :options="genders" optionLabel="label"
                                placeholder="Select" />
                        ...
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Cooperative/Farmer Group
                                </label>
                                <InputText id="username2" :style="{ borderRadius: '8px' }" type="username" class="p-error"
                                v-model="noOfAcres" aria-describedby="username-help" />
                        </div>
                ...
                <div :style="{ 'margin-left': '-22px' }">
                    ...
                    <div class="flex gap-2 ml-3">
                        <div class="field flex-1 flex flex-column">
                            ...
                            <InputText id="username2" :style="{ borderRadius: '8px' }" type="username" class="p-error" placeholder="eg. kiricoop"
                    ...
                    <div class="flex gap-2 ml-3">
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">County
                                </label>
                            <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedCounty" :options="counties" optionLabel="label" @change="getSubcountiesByCountyId"
                                placeholder="Select" />
                            <!-- <Dropdown id="deliveryLocation" v-model="selectedDeliveryLocation" :options="deliveryLocations" placeholder="Select Delivery Location" /> -->
                        </div>
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod"
                                :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Sub County</label>
                            <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedSubCounty" :options="subCounties" optionLabel="label" @change="getWardsBySubcountyId"
                                placeholder="Select" />
                        </div>
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod"
                                :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Ward</label>
                            <Dropdown id="deliveryWindow" :style="{ borderRadius: '8px' }"
                                v-model="selectedWard" :options="wards" optionLabel="label"
                                placeholder="Select" />
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div :style="{ 'margin-left': '-22px' }">
                    ...
                    <div class="flex gap-2 ml-3">
                        ...
                        <div class="field flex-1 flex flex-column">
                            <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">KRA PIN
                                Preferences </label>
                                <InputNumber id="username2" :style="{ borderRadius: '8px' }" type="username" class="p-error"
                                v-model="mpesaNumber" aria-describedby="username-help" />
                        </div>
        ...
        <div class="col-12 md:col-4">
            ...
            <div class="card p-fluid" :style="{}">
                ...
                <div :style="{ display: 'flex', 'flex-direction': 'column', gap: '16px' }">
                    ...
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">Irrigaton</div>
                        <div>{{email?email:'-'}}</div>
                    </div>
                    <div class="flex justify-content-between">
                ...
                <div :style="{ display: 'flex', 'flex-direction': 'column', gap: '16px' }">
                    ...
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">County</div>
                        <div>{{coordinates?coordinates:'-'}}</div>
                    </div>
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">Sub County</div>
                        <div>{{phone?phone:'-'}}</div>
                    </div>
                    <div class="flex justify-content-between">
                        <div :style="{ 'font-color': '#F6F6F6' }">Ward</div>
                        <div>{{phone?phone:'-'}}</div>
                    </div>
