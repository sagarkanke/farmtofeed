...
const farmersList = ref([
    {
        ...
        },
        {
          ...
          supplier: 'Sunny Agriculture',
          cropsAvailable: 'Rice, Barley',
          activeOrders: 1,
          totalOrders: 3,
          status: 'inactive',
        },
        {
          ...
          supplier: 'Harvest Fields',
          cropsAvailable: 'Soybeans, Potatoes',
          activeOrders: 3,
          totalOrders: 7,
          status: 'active',
        },
        {
          ...
          cropsAvailable: 'Tomatoes, Onions',
          activeOrders: 0,
          totalOrders: 2,
          status: 'inactive',
        },
        {
          ...
          cropsAvailable: 'Peppers, Lettuce',
          activeOrders: 4,
          totalOrders: 6,
          status: 'active',
        },
...
const handleMenuAction = (event, item) => {
    ...
    if (event === 'Edit') {
        store.commit('farmer/setSelectedItem', selectedItem);
        router.push({ path: '/sourcing/edit-farmer' });
    } else if (event === 'Delete') {
        deleteProductDialog.value = true;
    }else if(event === 'View'){
        store.commit('farmer/setSelectedItem', selectedItem);
        router.push({ path: '/sourcing/farmer-details' });
    }
    }
...
const newOrder = () => {
    router.push({ path: '/sourcing/new-farmer' });
};
                ...
                >
                    <template #header>
                        <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center" :style="{ 'margin-top': '-20px', 'margin-left': '-15px' }">
                            <h5 class="m-0 text-color-secondary">Farmer</h5>
                        </div>
                        <div class="flex justify-content-between gap-6 mt-2" :style="{ 'margin-left': '-15px' }">
                            ...
                            <div class="flex gap-2" :style="{ 'margin-right': '-22px' }">
                                ...
                                <Button type="button" label="New Farmer" icon="pi pi-plus" :style="{ 'background-color': 'darkgreen', border: 'darkgreen' }" @click="newOrder()"></Button>
                            </div>
                        </div>
                    </template>
                    <Column field="farmerName" header="Farmer Name"  headerStyle="width:14%; min-width:13rem;">
                        <template #body="slotProps">
                            {{ slotProps.data.farmerName }}
                        </template>
                    </Column>
                    ...
                    <Column field="email" header="Email"  headerStyle="width:14%; min-width:11rem;">
                        <template #body="slotProps">
                    ...
                    <Column field="cropsAvailable" header="Crops Available"  headerStyle="width:14%; min-width:13rem;">
                        <template #body="slotProps">
                            {{ slotProps.data.cropsAvailable }}
                        </template>
                    </Column>
                    <Column field="activeOrders" header="Active Orders" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            {{ slotProps.data.activeOrders }}                        </template>
                    </Column>
                    <Column field="totalOrders" header="Total Orders" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            {{ slotProps.data.totalOrders }}                        </template>
                    </Column>
