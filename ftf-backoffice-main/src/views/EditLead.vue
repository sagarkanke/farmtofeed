...
const selectedItem = computed(() => store.getters['leads/getSelectedItem']);
...
<template>
    <div class="flex justify-content-between">
        <router-link :to="{ path: '/sales/leads' }" class="back-arrow">
            <i class="pi pi-arrow-left" :style="{ 'color': '#122C20' ,'margin-left': '-2rem'}"></i>
        </router-link> <Span :style="{ 'font-size': 'large', 'font-weight': 'bold','margin-left': '-40rem' ,'color': '#122C20'}"> Edit Lead :{{ selectedItem.customer }}</span> 
    ...
    <div class="grid" :style="{ 'margin-left': '-2rem' }">
            ...
            <div class="card p-fluid" :style="{}">
                <div class="flex flex-column">
                    <div>
                        ...
                        <Dropdown id="paymentType" :style="{ borderRadius: '8px' }" v-model="selectedBusinessCategory"
                            :options="businessCategories" optionLabel="label" placeholder="Select" />
                    </div>
                    <div class="mt-3">
                        <label for="deliveryMethod" :style="{ 'font-weight': 'bold', 'font-size': 'small' }">Contact
                            Date
                        </label>
        ...
        <div :style="{ width: '64%', 'margin-top': '-71%' }">
            <div class="card">
        ...
        <div :style="{ width: '64%', 'margin-top': '-39%' }">
            <div class="card">
